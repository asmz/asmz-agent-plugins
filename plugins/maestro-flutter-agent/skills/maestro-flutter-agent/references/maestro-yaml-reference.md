...
1. `id:` — Semantics identifierベース。最も安定
2. `text:` — 表示テキストベース。正規表現対応
3. `point:` — 座標ベース。最終手段
...
### CLI引数
```bash
maestro test -e APP_ID=com.example.app -e SEARCH_KEYWORD=Flutter flow.yaml
```
